                            ...
                            <ul class="dropdown-menu  dropdown-menu-end  px-2 py-3 me-sm-n4"
                                ...
                                <li class="mb-2">
                                    <a class="dropdown-item border-radius-md" href="javascript:;">
                                        <div class="d-flex py-1">
                                            <div class="my-auto">
                                                <img src="https://demos.creative-tim.com/material-dashboard/{{ asset('admin/') }}assets/img/small-logos/logo-spotify.svg"
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <div class="d-flex px-2 py-1">
                                                    <div>
                                                        <img src="https://demos.creative-tim.com/material-dashboard/{{ asset('admin/') }}assets/img/small-logos/logo-xd.svg"
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex px-2 py-1">
                                                    <div>
                                                        <img src="https://demos.creative-tim.com/material-dashboard/{{ asset('admin/') }}assets/img/small-logos/logo-atlassian.svg"
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex px-2 py-1">
                                                    <div>
                                                        <img src="https://demos.creative-tim.com/material-dashboard/{{ asset('admin/') }}assets/img/small-logos/logo-slack.svg"
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex px-2 py-1">
                                                    <div>
                                                        <img src="https://demos.creative-tim.com/material-dashboard/{{ asset('admin/') }}assets/img/small-logos/logo-jira.svg"
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex px-2 py-1">
                                                    <div>
                                                        <img src="https://demos.creative-tim.com/material-dashboard/{{ asset('admin/') }}assets/img/small-logos/logo-invision.svg"
